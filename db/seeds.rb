...
Guitar.create!(name: "Awesome vintage Fender Stratocaster", description: "Nice 1964 Fender Stratocaster, perfect for any type of music", brand: "Fender", category: "Electric", location: "Paris", daily_price: 160.50, user: User.all.sample)
Guitar.create!(name: "Taylor 114ce Walnut", description: "A very pure sound and a very fine material, a perfect body zise with an extraordinary griff.", brand: "Gibson", category: "Acoustic", location:"London", daily_price: 80.20, user: User.all.sample)
