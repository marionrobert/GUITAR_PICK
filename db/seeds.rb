...
guitar1 = Guitar.new(name: "Awesome vintage Fender Stratocaster", description: "Nice 1964 Fender Stratocaster, perfect for any type of music", brand: "Fender", category: "Electric", address: "Paris", daily_price: 160.50, user: User.all.sample)
...
guitar2 = Guitar.create!(name: "Taylor 114ce Walnut", description: "A very pure sound and a very fine material, a perfect body size with an extraordinary griff.", brand: "Taylor", category: "Acoustic", address:"London", daily_price: 80.20, user: User.all.sample)
...
guitar3 = Guitar.create!(name: "Epiphone DR-100", description: "Just starting out? This is the best acoustic guitar for you.", brand: "Epiphone", category: "Acoustic", address:"Boulogne", daily_price: 50.00, user: User.all.sample)
...
guitar4 = Guitar.create!(name: "Fender Player Stratocaster", description: "The sonically flexible Player Stratocaster HSS is packed with authentic Fender feel and style.", brand: "Fender", category: "Electric", address:"Clichy", daily_price: 110.50, user: User.all.sample)
...
guitar5 = Guitar.create!(name: "Kurt Cobain Jag-Stang", description: "This Jag-Stang comes equipped with the same features that made it Kurt’s ideal instrument.", brand: "Fender", category: "Electric", address:"Montrouge", daily_price: 150.00, user: User.all.sample)
...
guitar6 = Guitar.create!(name: "Taylor AD17 Blacktop", description: "The AD17 Blacktop is an all-acoustic guitar that blends a contemporary feel with a classic sound.", brand: "Taylor", category: "Acoustic", address:"Paris XX", daily_price: 92.00, user: User.all.sample)
...
guitar7 = Guitar.create!(name: "Epiphone Les Paul Studio", description: "An incredible introduction to the world’s greatest electric guitar that is affordable for everyone.", brand: "Epiphone", category: "Electric", address:"Paris XI", daily_price: 35.00, user: User.all.sample)
...
guitar8 = Guitar.create!(name: "Epiphone SG Bass E1 Cherry", description: "This bass makes the authentic SG shape available to all bass players with its easy to play neck and total fret access.", brand: "Epiphone", category: "Bass", address:"Paris III", daily_price: 45.00, user: User.all.sample)
...
guitar9 = Guitar.create!(name: "Epiphone Bird DG1 Sunburst", description: "The Bird acoustic and electro- acoustic range is especially designed for beginner guitarists in mind.", brand: "Epiphone", category: "Acoustic", address:"Paris XIII", daily_price: 25.00, user: User.all.sample)
...
guitar10 = Guitar.create!(name: "Taylor AD27e Flametop", description: "The AD27e Flametop brings a new sonic flavor with an earthy, broken-in character.", brand: "Taylor", category: "Acoustic", address:"Paris IX", daily_price: 108.50, user: User.all.sample)
...
guitar11 = Guitar.create!(name: "Fender Player Mustang", description: "Versatile sound, classic style.", brand: "Fender", category: "Bass", address:"Paris", daily_price: 90.50, user: User.all.sample)
...
guitar12 = Guitar.create!(name: "American Original Telecaster", description: "One of the most versatile guitars ever created, the Telecaster is easily at home in any genre.", brand: "Fender", category: "Electric", address:"Paris II", daily_price: 64.00, user: User.all.sample)
